...
<head>
    ...
    <link type="text/css" href="{{ url('public/assets/css/addons-pro/stepper.css') }}" rel="stylesheet">
<!--
Stepper CSS - minified-->
<link type="text/css" href="{{ url('public/assets/css/addons-pro/stepper.min.css') }}" rel="stylesheet">
    ...
    <script type="text/javascript" src="{{ url('https://cdn.jsdelivr.net/npm/signature_pad@2.3.2/dist/signature_pad.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/assets/js/jquery-3.3.1.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/assets/js/delete.handler.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/assets/js/modules/toastr.js') }}"></script>
  

    <script type="text/javascript" src="https://f.vimeocdn.com/js/froogaloop2.min.js"></script>
    <script type="text/javascript" src="https://code.jquery.com/jquery-1.12.4.min.js"></script>

    <script type="text/javascript" src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=xtyhuf4jcvx14hba5xdmoird6al6xaza7rz13b4c0ic8po15"></script>
    ...
    <script type="text/javascript" src="{{ url('public/assets/js/addons-pro/stepper.js') }}"></script>
<!-- Stepper JavaScript - minified -->
<script type="text/javascript" src="{{ url('public/assets/js/addons-pro/stepper.min.js') }}"></script>
...
<script type="text/javascript" src="{{ url('resources/assets/js/app.js') }}"></script>
...
<script type="text/javascript" src="{{ url('public/assets/js/mobiscroll.jquery.min.js') }}"></script>

<script type="text/javascript" src="{{ url('public/assets/js/addons/datatables.min.js') }}"></script>
