...
class EmployeesAccessExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize
{
    /**
    ...
    public function map($employees): array
    {
        return [
            ...
            $employees->email,
            $employees->eid,
            ($employees->employeepositions->label ? $employees->employeepositions->label : '')
        ];
    }
