...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.list', compact('users', 'statuses', 'companies'));
    }
    ...
    public function view(User $user, ActivityRepository $activities)
    {
        ...
        return view('user.view', compact('user', 'userActivities', 'companies'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('user.add', compact('countries', 'roles', 'statuses', 'companies'));
    }
    ...
    public function edit(User $user, CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view(
            'user.edit',
            compact('edit', 'user', 'countries', 'socialLogins', 'roles', 'statuses', 'companies')
        );
    }
