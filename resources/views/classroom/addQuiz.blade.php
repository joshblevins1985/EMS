...
@section('content')
    ...
    <form action="/classroom/addQuiz" method="post">
        ...
        <input type="text" class="form-control mb-2" name="label" placeholder="Title of topic/quiz">
        <input type="text" class="form-control mb-2" id="datepicker-default" name="due_date"
        ...
        <div class="form-group row m-b-10">
            <label class="col-md-3 col-form-label">Graded</label>
            <div class="col-md-9">
                <div class="radio radio-css radio-inline">
                    <input type="radio" name="graded" id="inlineCssRadio3" value="1" checked/>
                    <label for="inlineCssRadio1">Yes</label>
                </div>
                <div class="radio radio-css radio-inline">
                    <input type="radio" name="graded" id="inlineCssRadio4" value="0"/>
                    <label for="inlineCssRadio2">No</label>
                </div>
            </div>
        </div>
