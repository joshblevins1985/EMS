                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4>Notification for Financial Assistance Request.</h4>
                                                    <p class="m-b-5">Please see the attached pdf agreement you signed</p>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h4>Thank You</h4>
                                                    <p>
                                                        You manager has recieved your request for financial assistance, please allow several days for this to process to the next step. A member of management will be in contact with you as soon as we have made a decision on this agreement.
                                                    </p>
                                                    <p>
                                                        <a href="/"><img src="/assets/img/forms_documents.png" /></a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
