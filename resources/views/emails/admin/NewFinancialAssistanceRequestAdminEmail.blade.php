                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td class="text-right valign-middle">
                                                        <span class="template-label">Notification Email</span>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4>Notification {{$signature->employee->first_name}} {{$signature->employee->last_name}} has requested educational financial assistance..</h4>
                                                    <p class="m-b-5">Please see the attached pdf agreement signed by the employees</p>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h4>Thank You</h4>
                                                    <p>
                                                        You have recieved this notification requesting your approval for the assistance requested. Please click the button to proceed online to sign the agreement.
                                                    </p>
                                                    <p>
                                                        <a href="/fa/review/{{$record->id}}" ><button type="button" class="btn btn-primary">Aprove Application</button></a>
                                                    </p>
                                                    <p>
                                                        <a href="/"><img src="/public/assets/img/forms_documents.png" /></a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
