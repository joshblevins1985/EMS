                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        <a href="/"><img src="https://www.peasi.app/public/assets/img/emscomplete.logo.png" height="20px" /></a>
                                                    </td>
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td class="text-right valign-middle">
                                                        <a href="javascript:;">Vehicle Repair Complete</a>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                ...
                                <tr>
                                    <td class="wrapper">
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h4>Latest Repair Update.</h4>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <a href="/"><img src="https://www.peasi.app/public/assets/img/repair_email.jpg" /></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <p class="last">
                                                        A repair on unit number {{$task->unit_id or 'Unknown'}} has been completed. Please see the attached report to see details about the repair and unit status.
                                                    </p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
