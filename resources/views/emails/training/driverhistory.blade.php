                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                            ...
                            <tr>
                                <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                    <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">Weekly Employee Status Report</h1>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <p>Please see the attached PDF file, which contains a list of newly cleared drivers form the last week, field training employees, and driver orientation employees.</p>
                                                                        <p>Please keep in mind that the training department only changes the status of an employee after a completed packet has been recieved, reviewed and updated. If there is a concern or question in reference to a status of an employee on the list please contact the education department by email.</p>

                                                                        <p>If you have any questions or concerns please contact the education department.</p>
