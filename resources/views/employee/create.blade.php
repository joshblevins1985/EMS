...
<div class=row >
    <div class="col-6 ">
        <div class=row>
            <div class="md-form">
                <input type="hidden" id="company_id" name="company_id" value="{{$user->companies_id}}"  class="form-control">
            ...
            <div class="col-9">
                ...
                <div class="md-form">
                    ...
                    <input type="text" id="eid" name="eid" class="form-control validate" placeholder="Employee ID" required>
            ...
            <div class="col-9">
                ...
                <div class="md-form">
                    <i class="fa fa-id-card prefix"></i>
                    <input type="text" id="rfid" name="rfid" class="form-control validate" placeholder="Employee RFID" required>
        ...
        <div class=row>
            ...
            <div class="col-9">
                <div class="md-form">
                    ...
                    <input type="email" id="personal_email" name="personal_email" class="form-control validate" placeholder="Personal Email"  disabled>
        ...
        <div class=row>
            ...
            <div class="col-9">
                <div class="md-form">
                    <i class="fa fa-envelope prefix"></i>
                    <input type="email" id="email" name="email" class="form-control validate" placeholder="Work Email" required>
    ...
    <div class="col-6">
        ...
        <div class="d-flex flex-column">
            <div class=row>
                ...
                <div class="col-9">
                    <select class="mdb-select" id="company_id" name="company_id" value="">
            ...
            <div class=row>
                ...
                <div class="col-9">
                    <select class="mdb-select" id="primary_position" name="primary_position">
                        <option value="" disabled selected>Choose Employees Primary Position</option>
            ...
            <div class=row>
                ...
                <div class="col-9">
                    <select class="mdb-select colorful-select dropdown-primary" id="additional_postions" name="additional_postions[]"  multiple searchable="Search here..">
        ...
        <div class=row>
            ...
            <div class="col-9">
                <div class="md-form">
                    <input placeholder="Date of Hire" type="text" name="doh" id="doh" class="form-control datepicker">
        ...
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="dd1" name="driver" value="1" >
          <label class="custom-control-label" for="dd1">Driver</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="dd2" name="driver" value="2" >
          <label class="custom-control-label" for="dd2">Non-Driver</label>
            ...
            <div class=row>
                ...
                <div class="col-9">
                    ...
                    <!-- Default inline 1-->
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="ddd1" name="nd_reason" value="1" >
          <label class="custom-control-label" for="ddd1">Insurance</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="ddd2" name="nd_reason" value="2">
          <label class="custom-control-label" for="ddd2">Accident</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="ddd3" name="nd_reason" value="3" >
          <label class="custom-control-label" for="ddd3">Administration</label>
            ...
            <div class="col-9">
                <div class="md-form">
                    <input placeholder="Date of Hire" type="text" name="dod" id="dod" class="form-control datepicker" >
        ...
        <div class="d-flex flex-column">
            <div class=row>
                ...
                <div class="col-9">
                    ...
                    <!-- Default inline 1-->
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d1" name="status" value="1" >
          <label class="custom-control-label" for="d1">Applicant</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d2" name="status" value="2" checked>
        ...
        <div class="custom-control custom-radio custom-control-inline">
          ...
          <label class="custom-control-label" for="d3">Orientation</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d4" name="status" value="4">
          <label class="custom-control-label" for="d4">Field Training</label>
        </div>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d5" name="status" value="5" >
          <label class="custom-control-label" for="d5">Active</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d6" name="status" value="6" >
          <label class="custom-control-label" for="d6">FMLA</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d7" name="status" value="7" >
          <label class="custom-control-label" for="d7">COMP</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input type="radio" class="custom-control-input" id="d8" name="status" value="8" >
          <label class="custom-control-label" for="d8">Terminated</label>
            ...
            <div class="text-center mb-3">
                <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-1a">Create New Employee</button>
            </div>
        </div>
