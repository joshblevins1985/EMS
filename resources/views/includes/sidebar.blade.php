            ...
            <li class="nav-profile">
                <a href="javascript:;" data-toggle="nav-profile">
                    ...
                    <div class="info">
                        ...
                        <small>Position: {{Auth::user()->Employee->employeepositions->label }} </small>
                        <small>Phone: {{ '('.substr(Auth::user()->employee->phone_mobile, 0, 3).') '.substr(Auth::user()->employee->phone_mobile, 3, 3).'-'.substr(Auth::user()->employee->phone_mobile,6)  }} </small>
