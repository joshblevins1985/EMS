    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="../../index.html"><img src="/assets/corona/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="../../index.html"><img src="/assets/corona/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="/assets/corona/images/faces/face15.jpg" alt="">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="/assets/corona/images/logo-mini.svg" alt="logo" /></a>
          </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="/assets/corona/images/faces/face4.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="/assets/corona/images/faces/face2.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="/assets/corona/images/faces/face3.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      <div class="col-4 col-sm-3 col-xl-2">
                        <img src="/assets/corona/images/dashboard/Group126@2x.png" class="gradient-corona-img img-fluid" alt="">
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      ...
                      <div class="align-self-center flex-grow text-left text-md-center text-xl-left py-md-2 py-xl-0">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          ...
                          <p class="text-success mr-2 mb-0 font-weight-medium">+8.3%</p>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          ...
                          <p class="text-danger mr-2 mb-0 font-weight-medium">-2.1% </p>
                        </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img src="/assets/corona/images/faces/face1.jpg" alt="image" />
                              <span class="pr-2">Henry Klein</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Dashboard </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="/assets/corona/images/faces/face2.jpg" alt="image" />
                              <span class="pr-2">Estella Bryan</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Website </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="/assets/corona/images/faces/face5.jpg" alt="image" />
                              <span class="pr-2">Lucy Abbott</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> App design </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="/assets/corona/images/faces/face3.jpg" alt="image" />
                              <span class="pr-2">Peter Gill</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Development </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="/assets/corona/images/faces/face4.jpg" alt="image" />
                              <span class="pr-2">Sallie Reyes</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Website </td>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="preview-list">
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="/assets/corona/images/faces/face6.jpg" alt="image" class="rounded-circle" />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="/assets/corona/images/faces/face8.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="/assets/corona/images/faces/face9.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="/assets/corona/images/faces/face11.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel">
                      <div class="item">
                        <img src="/assets/corona/images/dashboard/Rectangle.jpg" alt="">
                      </div>
                      <div class="item">
                        <img src="/assets/corona/images/dashboard/Img_5.jpg" alt="">
                      </div>
                      <div class="item">
                        <img src="/assets/corona/images/dashboard/img_6.jpg" alt="">
                      </div>
                    </div>
                    <div class="d-flex py-4">
                      <div class="preview-list w-100">
                        <div class="preview-item p-0">
                          <div class="preview-thumbnail">
                            <img src="/assets/corona/images/faces/face12.jpg" class="rounded-circle" alt="">
                          </div>
                          <div class="preview-item-content d-flex flex-grow">
                            <div class="flex-grow">
                              <div class="d-flex d-md-block d-xl-flex justify-content-between">
