<!-- begin card -->
        <div class="card border-0 bg-success text-white mb-3 overflow-hidden">
            <img class="card-img-top" src="/assets/img/completed.jpg" height="100px" alt="Card image cap" draggable= true dragenter="true" dragover="true" drop="true" dragleave="true" data-status="5" data-drop="true" data-user_id="">
            <!-- begin card-body -->
            <div class="card-body mb-5" >
                <!-- begin row -->
                <div class="row mb-5 " draggable="true"  >
                    <!-- begin col-6 -->
                    <div class="col-xl-12"  >
                        <!-- begin card -->
                        <div class="card border-0 bg-dark text-white mb-3 overflow-hidden">
                            <!-- begin card-body -->
                            <div class="card-body" id="status_5" >
                                @foreach($data->where('status', 5) as $row)
                    ...
                    @endif
                    <div class="row" id="{{$row->id}}" draggable="true"  data-id="{{$row->id}}" >
                    <!-- begin col-12 -->
                    <div class="col-xl-12 "  >
                        <!-- begin card -->
                        <div class="card border-0 bg-dark text-white mb-3 overflow-hidden">
