		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-dark">
				...
				<div class="stats-content">
					...
					<div class="stats-number">{{ count($units->where('type', 1)) }}</div>
    ...
    <div class="row">
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-warning">
				<div class="stats-icon stats-icon-lg"><i class="fad fa-oil-can fa-fw"></i></div>
				<div class="stats-content">
					<div class="stats-title">Total Requiring Mileage Service</div>
					<div class="stats-number">{{ count($service) }}</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 54.9%;"></div>
					</div>
					<div class="stats-desc">Better than last week (54.9%)</div>
					<div class="text-right"><a href="/unit/Service">View Report</a></div>
				</div>
			</div>
		</div>
		<!-- end col-3 -->
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-primary">
				<div class="stats-icon stats-icon-lg"><i class="fas fa-tools fa-fw"></i></div>
				<div class="stats-content">
					<div class="stats-title">Total Requiring Mechanical Service</div>
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-primary">
				<div class="stats-icon stats-icon-lg"><i class="fal fa-car-crash fa-fw"></i></div>
				<div class="stats-content">
					<div class="stats-title">Total Requiring Body Work</div>
					<div class="stats-number">0</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 54.9%;"></div>
					</div>
